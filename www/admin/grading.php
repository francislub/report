...
<div class="container">
<h2 class="mb-4">
<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#NewSubject">ADD GRADE</button>
</h2>
<h2 class="mb-4">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-warning text-light">
        <h5 class="modal-title" id="exampleModalLabel">NEW GRADING</h5>
	  ...
	  <div class="modal-body">
        <form action="action.php" method="POST" enctype="multipart/form-data">
		  ...
		  <div class="row">
                ...
                <div class="col">
                    <label for="recipient-name" class="col-form-label">Grade/Identifier:</label>
                    <input type="text" class="form-control" id="subjectname" name="subjectname">
                    <br>
                    <input type="text" class="form-control" id="subjectname" name="subjectname">
                    <br>
                ...
                <div class="col">
                    <label for="recipient-name" class="col-form-label">Comment/Description:</label>
                    <input type="text" class="form-control" id="subjectname" name="subjectname">
                    <br>
                    <input type="text" class="form-control" id="subjectname" name="subjectname">
                    <br>
		...
		<div class="modal-footer">
			<button type="submit" name="submit" value="addsubject" class="btn btn-primary">ADD GRADING</button>
		</div>
        </form>
      </div>
  </div></div>
