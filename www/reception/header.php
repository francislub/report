...
<div class="wrapper d-flex align-items-stretch">
	...
	<ul class="list-unstyled components mb-5">
		...
		<li>
			<a href="index.php?visitors">Visitors</a>
		</li>
		<li>
			<a href="index.php?expenses">Expenses</a>
		</li>
		<li>
		...
		<a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Generate Reports</a>
		  <ul class="collapse list-unstyled" id="pageSubmenu">
			<li>
				<a href="index.php?students_report" class="disable-links">>students Report</a>
			</li>
			<li>
				<a href="index.php?visitors_report" class="disable-links">>visitors Report</a>
			</li>
			<li>
				<a href="index.php?Expenses_report" class="disable-links">>Expenses Report</a>
			</li>
		  </ul>
		</li>
	</ul>
	...
	<div class="footer">
		<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This sytem is developed <i class="icon-heart" aria-hidden="true"></i> by <a href="" target="_blank">Francis</a>
